...
export class UpdateTableLikeComment1714207988445 implements MigrationInterface {
    name = 'UpdateTableLikeComment1714207988445'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`like_product\` ADD \`total\` int NOT NULL DEFAULT '0'`);
